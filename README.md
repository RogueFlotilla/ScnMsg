...
![Wanted poster of the cat Byte McFluff](./other_content/wanted_poster) ![Fake phishing email from Meowzon Prime concerning tuna delivery]("./other_content/📧 Phishing Email Example.docx")
